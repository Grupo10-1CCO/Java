 ...
 * @author Wind
 */
public class SerialMaquina extends javax.swing.JFrame {

    /**
     * Creates new form SerialMaquina
     */
    public SerialMaquina() {
        initComponents();
    }
    
    public void setSerialMaquina(String serial){
        txtSerialMaquina.setText("Serial da Máquna: "+serial);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SerialMaquina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SerialMaquina().setVisible(true);
            }
        });
    }
